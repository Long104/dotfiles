return {
  ...
  keys = {
    ...
    { mode = "n", "<S-h>", "<cmd>Grapple toggle<cr>", desc = "Tag a file" },
    { "<C-r>", "<cmd>Grapple reset<cr>", desc = "reset" },
    { "<S-p>", "<cmd>Grapple toggle_tags<cr>", desc = "Toggle tags menu" },
    { "<leader>q", ":lua require(“grapple”).tag({ name = “” })", desc = "Toggle tags menu" },
